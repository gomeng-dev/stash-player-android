...
import gomeng.dev.stashplayer.core.model.imageFilterSummaryLabel
...
@Composable
fun StashImageSavedFilterSheet(
    savedFilters: List<LocalSavedImageFilter>,
    recentFilters: List<StashImageFilterState>,
    currentFilter: StashImageFilterState,
    savedFilterName: String,
    onSavedFilterNameChange: (String) -> Unit,
    onApplyRecentFilter: (StashImageFilterState) -> Unit,
    onApplySavedFilter: (LocalSavedImageFilter) -> Unit,
    onSaveCurrentFilter: (String, StashImageFilterState) -> Unit,
    onQuickSaveCurrentFilter: (String, StashImageFilterState) -> Unit,
    onDeleteSavedFilter: (LocalSavedImageFilter) -> Unit,
    onDismiss: () -> Unit,
) {
    ...
    val canSaveCurrent = !currentFilter.toImageSavedFilterPayload().isEmpty
                            ...
                            FlowRow(
                                ...
                                visibleRecentFilters.forEach { filter ->
                                    StashVisibilityFilterChip(
                                        ...
                                        label = {
                                            Text(
                                                text = filter.imageFilterSummaryLabel(),
                                                maxLines = 1,
                        ...
                        Row(
                            ...
                            TextButton(
                                onClick = {
                                    ...
                                    onQuickSaveCurrentFilter(currentFilter.quickSavedImageFilterName(suffix), currentFilter)
                                },
                                enabled = canSaveCurrent,
                            ) {
                        ...
                        Row(
                            ...
                            TextButton(
                                ...
                                Column(
                                    ...
                                    Text(
                                        text = savedFilter.filterState.imageFilterSummaryLabel(),
                                        maxLines = 1,
                                        overflow = TextOverflow.Ellipsis,
